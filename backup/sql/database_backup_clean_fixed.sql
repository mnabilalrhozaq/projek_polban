-- =====================================================
-- BACKUP DATABASE UIGM POLBAN - CLEAN VERSION
-- Generated: 2024-12-31
-- Description: Database backup yang sudah diperbaiki dan bersih
-- =====================================================
...
-- Create database
CREATE DATABASE `uigm_polban` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `uigm_polban`;
...
SELECT 'Super Admin: superadmin / superadmin123' as login1;
SELECT 'Admin Pusat: adminpusat / adminpusat123' as login2;
SELECT 'Admin JTE: adminjte / adminjte123' as login3;
SELECT 'Admin JTM: adminjtm / adminjtm123' as login4;
SELECT 'Admin JTS: adminjts / adminjts123' as login5;
SELECT 'Admin JTIK: adminjtik / adminjtik123' as login6;