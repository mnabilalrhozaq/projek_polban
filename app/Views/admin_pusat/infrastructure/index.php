...
<head>
    ...
    <title><?= $title ?? 'Setting & Infrastructure' ?></title>
...
<body>
    ...
    <div class="main-content">
        <div class="dashboard-header">
            <h1><i class="fas fa-building"></i> Setting & Infrastructure</h1>
            <p>Manajemen data infrastruktur kampus untuk UI GreenMetric</p>
        </div>

        <div class="alert alert-info">
            <i class="fas fa-info-circle me-2"></i>
            <strong>Coming Soon!</strong> Fitur Setting & Infrastructure sedang dalam pengembangan.
        </div>
        ...
        <div class="card">
            <div class="card-header">
                <h3><i class="fas fa-list"></i> Data Infrastructure</h3>
            </div>
            <div class="card-body">
                <div class="empty-state">
                    <i class="fas fa-building fa-3x text-muted mb-3"></i>
                    <p class="text-muted">Fitur ini sedang dalam pengembangan.</p>
                    <p class="text-muted">Data infrastruktur kampus akan ditampilkan di sini.</p>
                </div>
            </div>
        </div>
    </div>
