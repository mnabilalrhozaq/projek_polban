...
<body>
    ...
    <div class="main-content">
        <div class="dashboard-header">
            <h1><i class="fas fa-car"></i> Transportation</h1>
            <p>Manajemen data transportasi kampus untuk UI GreenMetric</p>
        </div>

        <div class="alert alert-info">
            <i class="fas fa-info-circle me-2"></i>
            <strong>Coming Soon!</strong> Fitur Transportation sedang dalam pengembangan.
        </div>
        ...
        <div class="card">
            <div class="card-header">
                <h3><i class="fas fa-list"></i> Data Transportation</h3>
            </div>
            <div class="card-body">
                <div class="empty-state">
                    <i class="fas fa-car fa-3x text-muted mb-3"></i>
                    <p class="text-muted">Fitur ini sedang dalam pengembangan.</p>
                    <p class="text-muted">Data transportasi kampus akan ditampilkan di sini.</p>
                </div>
            </div>
        </div>
    </div>
