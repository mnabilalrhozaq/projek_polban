...
<head>
    ...
    <title><?= $title ?? 'Laporan Education & Research' ?></title>
...
<body>
    ...
    <div class="main-content">
        <div class="dashboard-header">
            <h1><i class="fas fa-chart-bar"></i> Laporan Education & Research</h1>
            <p>Laporan dan analisis data pendidikan dan penelitian</p>
        </div>

        <div class="alert alert-info">
            <i class="fas fa-info-circle me-2"></i>
            <strong>Coming Soon!</strong> Fitur laporan education & research sedang dalam pengembangan.
        </div>

        <div class="card">
            <div class="card-header">
                <h3><i class="fas fa-file-alt"></i> Laporan Education & Research</h3>
            </div>
            <div class="card-body">
                <div class="empty-state">
                    <i class="fas fa-chart-pie fa-3x text-muted mb-3"></i>
                    <p class="text-muted">Laporan education & research akan ditampilkan di sini.</p>
                </div>
            </div>
        </div>
    </div>
